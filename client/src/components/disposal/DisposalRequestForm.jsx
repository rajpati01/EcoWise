  ...
  const handleSubmit = async (e) => {
    ...
    if (!category || !mode) {
      ...
      toast({
        ...
        description: "Category and mode are required.",
        variant: "destructive",
      });
      return;
    }
    ...
    if (mode === "self-deliver" && !centerId) {
      setMessage({
        type: "error",
        text: "Please select a preferred center for self-delivery.",
      });
      toast({
        title: "Validation error",
        description: "Please select a preferred center for self-delivery.",
        variant: "destructive",
      });
      return;
    }
    ...
    if (scheduledAt) {
      ...
      if (selected.getTime() < now.getTime() - 1000) {
        ...
        toast({
          title: "Validation error",
          description: "Scheduled date/time cannot be in the past.",
          variant: "destructive",
        });
        return;
      }
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <div className="mt-2 text-sm text-gray-700">
                Give the request ID above to the collector or drop-off attendant
                when handing over items.
              </div>
            </div>
            ...
            <div>
              ...
              <div className="font-medium">
                {typeof lastCreated.centerId === "object"
                  ...
                  : lastCreated.name || lastCreated.centerId || "No preference"}
              </div>
            </div>
          ...
          <div className="mt-3 flex items-center gap-3">
            <a
              href={`/profile/requests/${
                lastCreated._id || lastCreated.requestId
              }`}
