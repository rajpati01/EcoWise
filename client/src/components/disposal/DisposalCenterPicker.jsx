    ...
    <div>
      ...
      <div className="mt-2 text-sm text-gray-700 space-y-2">
        ...
        {nearest.length > 0
              ...
              >
                <div>
                  ...
                  <div className="flex mb-1">
                    ...
                    {c.address && (
                      <div className="mx-2 text-xs text-gray-600">{c.address}</div>
                    )}
                  </div>
                  <div className="flex mb-1">
                    <Phone className="h-4 w-4" />
                    {c.contact && (
                      <div className="mx-2 text-xs text-gray-500 mt-1">Phone: {c.contact}</div>
                    )}
                  </div>
                  <div className="flex">
                    <ArrowDownToDot className="h-4 w-4" />
                    {c.distanceKm != null && (
                      <div className="mx-2 text-xs text-gray-500 mt-1">~{c.distanceKm.toFixed(2)} km</div>
                    )}
                  </div>
                </div>
          ...
          : !loading && <div className="text-sm text-gray-500">No centers found.</div>}
      </div>
    </div>
  );
}
