...
// Simple ToastProvider (no-op for compatibility)
const ToastProvider = ({ children }) => children;

// Fixed ToastViewport - Bottom right corner with proper width
const ToastViewport = forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "fixed bottom-0 right-0 z-[100] flex max-h-screen flex-col gap-2 p-4 sm:bottom-4 sm:right-4 w-full sm:max-w-[420px]",
      className
    )}
    {...props}
  />
